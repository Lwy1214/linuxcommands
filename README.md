...
위의 코드는 파일을 읽어 처음 10줄을 출력합니다. 입력 파일이 지정되지 않은 경우에는 표준 입력으로부터 읽어옵니다.

파일이 아무것도 없는 널이면 파일을 열수 없다고 표시되도록 했습니다.
...
위의 코드는 파일을 읽어 마지막 10줄을 출력합니다. 입력 파일이 지정되지 않은 경우에는 표준 입력으로부터 읽어옵니다.
